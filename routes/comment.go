...
func NewMessage(code int, data any, msg string) *Message {
	return &Message{Code: code, Data: data, Msg: msg}
}
func OK(c *whs.Context) {
	Json(c, http.StatusOK, nil, "OK")
}
func OKWithMsg(c *whs.Context, msg string) {
	Json(c, http.StatusOK, nil, msg)
}
func OKWithData(c *whs.Context, data any, msg string) {
	Json(c, http.StatusOK, data, msg)
}

func Json(c *whs.Context, status int, data any, msg string) {
	c.Json(status, data, msg)
}
func Failed(c *whs.Context, code int, msg string) {
	Json(c, code, nil, msg)
}
